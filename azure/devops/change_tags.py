...
ORGANIZATION = ""
PROJECT = ""
# To find this Id, hit the endpoint "https://{ORGANIZATION}.visualstudio.com/{PROJECT}/_apis/distributedtask/deploymentgroups" replacing the project with the one you're looking for the deployment group in
...
TAGS_TO_DELETE = ""
# Comma-separated list of names of the machines that need to change (e.g., "machine1, machine2")
MACHINES_TO_CHANGE = ""
...
def main():
    ...
    for machine in machines:
        ...
        if machine_name in machines_to_change:
            ...
            updated_machines.append(
                {'tags': updated_tags, 'id': machine['id']})
    ...
    for machine in machines:
        print('-'*20)
        print(
            f"Machine ID: {machine['id']} | Machine name: {machine['agent']['name']}")
        print(
